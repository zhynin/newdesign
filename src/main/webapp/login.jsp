  ...
  <body>
    ...
    <div class="container">
      <form class="form-signin" action="loginServlet" method="post" id="frm">
              ...
              <label for="text" class="sr-only">请输入账号</label>
              <input type="text" id="manager_id" class="form-control" name="manager_id">
              <label for="inputPassword" class="sr-only">请输入密码</label>
              
              <input type="password" id="manager_pwd" class="form-control" name="manager_pwd">
              <div class="checkbox">
                <label>
                  <input type="checkbox" value="remember-me"> 记住我
                </label>
              </div>
              <a href="javascript:void(0)" onclick="postForm()" class="btn btn-lg btn-primary btn-block">登录</a>
    ...
    <script type="text/javascript">
    	function postForm() {
			...
			if(manager_pwd == "" || manager_id == ""){
				document.getElementById("msg").innerHTML="用户名或密码不完整！";
				return;
			}
