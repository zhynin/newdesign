...
<body>
	...
	<div class="container">
	<form action="editManager" class="form-register" id="frm" method="post">
	<h1 class="form-register-heading">修改管理员信息</h1>
	
	<div class="form-group">
    	<label for="exampleInputName2">登录账号</label>
    	<input type="text" class="form-control" id="manager_id" placeholder="请输入账号" name="manager_id" readonly="readonly" autocomplete="off" 
    	maxlength="10" value="<%=manager.getManager_id()%>" >
  	</div>
  	<div class="form-group">
    	<label for="exampleInputName2">真实姓名</label>
    	<input type="text" class="form-control" id="manager_name" placeholder="请输入姓名" name="manager_name" autocomplete="off" 
    	maxlength="20" value="<%=manager.getManager_name()%>">
  	</div>
  	<div class="form-group">
    	<label for="exampleInputPassword1">登录密码</label>
    	<input type="text" class="form-control" id="manager_pwd" placeholder="请输入密码" name="manager_pwd" autocomplete="off" 
    	maxlength="50" value="<%=manager.getManager_pwd()%>">
  	</div>
  	<div class="form-group">
  		<table>
    ...
    <script type="text/javascript">
    	...
    	function startPost() {
    		var ipts = ["manager_name", "manager_pwd"];
    		var lens = [2,6];
    		var msg = ["真实姓名不能为空！！", "密码不能少于六位！"];
    		var flag = true;
